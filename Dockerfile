...
WORKDIR /home/project
COPY ./ .
RUN /home/service/bin/service -p src/main/proto/th2_grpc_act_ui_win_framework_demo -w PythonServiceWriter -o src/gen/main/python/th2_grpc_act_ui_win_framework_demo
